...
public class OperasiInternet extends AsyncTask<String, String, String>{
	...
	//private String URL ="http://fajarlestari.sytes.net:2000/slo/";
	private String URL ="http://186.132.0.23/slo/";
	//private String URL ="http://10.0.2.2/slo/";
	...
	protected String doInBackground(String... params) {
		responsefromserver = SendToServer(URL+"/SLO/add_slo.php");
		return null;
	}
